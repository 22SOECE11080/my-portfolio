...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const serviceID = "service_2dhwrmq"; // Replace with your EmailJS service ID
    const templateID = "template_8kiwf5g"; // Replace with your EmailJS template ID
    const userID = "bdbQLIg--_9tmqDkr"; // Replace with your EmailJS user ID
            ...
            >
              <div className="card-body d-flex flex-column align-items-center">
                ...
                <div className="text-center">
                  ...
                  <a
                    href="mailto:radheshjoshi02@gmail.com"
            ...
            >
              <div className="card-body d-flex flex-column align-items-center">
                ...
                <div className="text-center">
                  ...
                  <a href="tel:+917984767883" className="card-text">
                    +91 7984767883
                  </a>
                </div>
              </div>
              ...
              <div className="card-body d-flex flex-column align-items-center">
                ...
                <div className="text-center">
                  <h5 className="card-title">Address</h5>
                    <a
                      href="https://maps.app.goo.gl/vH7NSNgRYBHDQx71A"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="card-text"
                    >
                      Street 7, Jljit socity, 150 feet Ring Road, Rajkot.
                    </a>
                </div>
              </div>
            </div>
